    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.enrollmentButton).setOnClickListener(view -> {
            ...
            OrganisationUnit orgUnit = Sdk.d2().organisationUnitModule()
                    .organisationUnits.byOrganisationUnitScope(OrganisationUnit.Scope.SCOPE_DATA_CAPTURE).one().get();
            ...
            TrackedEntityInstanceCreateProjection projection = TrackedEntityInstanceCreateProjection.builder()
                    ...
                    .trackedEntityType(program.trackedEntityType().uid()).build();

            try {
               teiUid =  Sdk.d2().trackedEntityModule().trackedEntityInstances.add(projection);
